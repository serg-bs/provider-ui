...
const BottomInterface = () => {
    ...
    return(
        <div className="PositionBottomMenu">
            ...
            <div className="footer">
                <div className="container">
                    <div className="footer__inner">
                        ...
                        <div className="footer__block">
                            <h4 className="footer__title">COЦИАЛЬНЫЕ СЕТИ</h4>
...
<a href="https://www.instagram.com/">
                        ...
                        <div className="footer__block">
                            ...
                            <div className="">
                            <pre><Link to="/">Главная</Link></pre>
                            <pre><Link to="/tariff">Тарифф</Link></pre>
                            <pre><Link to="/payments">Платежи</Link></pre>
                            <pre><Link to="/client">Инфо</Link></pre>
                            </div>
                        </div>
                    </div>
                </div>
